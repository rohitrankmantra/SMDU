    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <p className="text-text-muted leading-relaxed">
                Smt. Manjira Devi University, Uttarkashi is established as a
                Private University of Uttarakhand vide State Government
                Notification No 114/XXXVI(3)/2024/13(1)/2024 dated 16th March,
                2024.
              </p>
              ...
              <p className="mt-4 text-text-muted leading-relaxed">
                ...
                prosperous and to prevent migration of youth.
              </p>

              <p className="mt-4 text-text-muted leading-relaxed">
                Smt. Manjira Devi University, located in the serene Himalayan
                region of Uttarkashi, Uttarakhand, emerged from over two decades
                of experience as a group of institutions. Founded on principles
                of academic excellence, cultural preservation, and environmental
            ...
            <div className="lg:col-span-2 relative">
              ...
              <div className="pl-8 space-y-10">
                ...
                >
                  ...
                  <p className="text-text-muted leading-relaxed">
                    Uttarkashi is renowned for its deep religious significance
                    as a Hindu pilgrimage destination and its breathtaking
                    Himalayan landscape. Often referred to as the
                    <span className="text-[#f46b13] font-medium">
                      {" "}
                      “Kashi of the North”
                    </span>
                    , it serves as a spiritual gateway to the revered Char Dham
                    Yatra, particularly Gangotri.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-text-muted leading-relaxed">
                    The historic Kashi Vishwanath Temple, dedicated to Lord
                    Shiva, is one of the town’s most prominent landmarks and is
                    regarded as one of the twelve Jyotirlingas. Believed to have
                    been constructed in the 8th century during the Parmar
                    dynasty, the temple symbolizes centuries of devotion,
                ...
                >
                  ...
                  <p className="text-text-muted leading-relaxed">
                    ...
                    , Uttarkashi holds a sacred place in Hindu traditions. As a
                    vital halt on the Char Dham pilgrimage route, the region
                    blends spirituality, natural beauty, and cultural
                    heritage—shaping an environment ideal for reflective
                    learning and holistic education.
                  </p>
                </motion.div>
              </div>
            </div>
      ...
      <section className="py-24 relative overflow-hidden bg-white">
        ...
        "
            ...
            <p className="mt-4 text-text-muted leading-relaxed">
              A sacred Himalayan land where spirituality, nature, and learning
              exist in harmony.
            </p>
          </motion.div>
